...
namespace Crosslight.Common.UI.Controls.HexEditorControl.Core
{
    ...
    public class CustomBackgroundBlock : ICloneable
    {
        ...
        public CustomBackgroundBlock(string start, long length, SolidColorBrush color)
        {
            ...
            StartOffset = success ? position : throw new Exception(Localizer.Localizer.Instance["HexEditor/ConvertStringToLongErrorString"]);
            Length = length;
            Color = color;
        }
        ...
        /// </summary>
        public ISolidColorBrush Color { get; set; } = Brushes.Transparent;
