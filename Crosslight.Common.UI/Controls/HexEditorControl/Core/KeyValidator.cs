...
namespace Crosslight.Common.UI.Controls.HexEditorControl.Core
{
    ...
    public static class KeyValidator
    {
        ...
        public static bool IsCtrlCKey(KeyGesture key) => key.Key == Key.C && key.KeyModifiers == KeyModifiers.Control;

        public static bool IsCtrlZKey(KeyGesture key) => key.Key == Key.Z && key.KeyModifiers == KeyModifiers.Control;

        public static bool IsCtrlYKey(KeyGesture key) => key.Key == Key.Y && key.KeyModifiers == KeyModifiers.Control;

        public static bool IsCtrlVKey(KeyGesture key) => key.Key == Key.V && key.KeyModifiers == KeyModifiers.Control;

        public static bool IsCtrlAKey(KeyGesture key) => key.Key == Key.A && key.KeyModifiers == KeyModifiers.Control;
