...
// From https://github.com/abbaye/WpfHexEditorControl
using Avalonia;
...
using Crosslight.Common.UI.Controls.HexEditorControl;
...
using Crosslight.Common.UI.Controls.HexEditorControl.Dialog;
...
using static Crosslight.Common.UI.Controls.HexEditorControl.Core.Bytes.ByteConverters;
using static Crosslight.Common.UI.Controls.HexEditorControl.Core.Bytes.ByteProvider;
...
namespace Crosslight.Common.UI.Controls
{
    ...
    /// </remarks>
    public class HexEditor : UserControl
    {
        ...
        public ContextMenu CMenu => this.FindControl<ContextMenu>("CMenu");
        public MenuItem UndoCMenu => this.FindControl<MenuItem>("UndoCMenu");
        public MenuItem BookMarkCMenu => this.FindControl<MenuItem>("BookMarkCMenu");
        public MenuItem ClearBookMarkCMenu => this.FindControl<MenuItem>("ClearBookMarkCMenu");
        public MenuItem CopyHexaCMenu => this.FindControl<MenuItem>("CopyHexaCMenu");
        public MenuItem CopyAsciicMenu => this.FindControl<MenuItem>("CopyAsciicMenu");
        public MenuItem CopyAsCMenu => this.FindControl<MenuItem>("CopyAsCMenu");
        public MenuItem CopyCcMenu => this.FindControl<MenuItem>("CopyCcMenu");
        public MenuItem CopyCSharpCMenu => this.FindControl<MenuItem>("CopyCSharpCMenu");
        public MenuItem CopyFSharpCMenu => this.FindControl<MenuItem>("CopyFSharpCMenu");
        public MenuItem CopyJavaCMenu => this.FindControl<MenuItem>("CopyJavaCMenu");
        public MenuItem CopyVbNetCMenu => this.FindControl<MenuItem>("CopyVbNetCMenu");
        public MenuItem CopyPascalCMenu => this.FindControl<MenuItem>("CopyPascalCMenu");
        public MenuItem CopyTblcMenu => this.FindControl<MenuItem>("CopyTblcMenu");
        public MenuItem PasteMenu => this.FindControl<MenuItem>("PasteMenu");
        public MenuItem FillByteCMenu => this.FindControl<MenuItem>("FillByteCMenu");
        public MenuItem ReplaceByteCMenu => this.FindControl<MenuItem>("ReplaceByteCMenu");
        public MenuItem DeleteCMenu => this.FindControl<MenuItem>("DeleteCMenu");
        public MenuItem FindAllCMenu => this.FindControl<MenuItem>("FindAllCMenu");
        public MenuItem SelectAllCMenu => this.FindControl<MenuItem>("SelectAllCMenu");

        public Grid BaseGrid => this.FindControl<Grid>("BaseGrid");

        public StackPanel LinesInfoStackPanel => this.FindControl<StackPanel>("LinesInfoStackPanel");
        public LayoutTransformControl LinesInfoStackPanelLayout => this.FindControl<LayoutTransformControl>("LinesInfoStackPanelLayout");
        public StackPanel HexDataStackPanel => this.FindControl<StackPanel>("HexDataStackPanel");
        public LayoutTransformControl HexDataStackPanelLayout => this.FindControl<LayoutTransformControl>("HexDataStackPanelLayout");
        public StackPanel HexHeaderStackPanel => this.FindControl<StackPanel>("HexHeaderStackPanel");
        public LayoutTransformControl HexHeaderStackPanelLayout => this.FindControl<LayoutTransformControl>("HexHeaderStackPanelLayout");
        public StackPanel StringDataStackPanel => this.FindControl<StackPanel>("StringDataStackPanel");
        public LayoutTransformControl StringDataStackPanelLayout => this.FindControl<LayoutTransformControl>("StringDataStackPanelLayout");

        public Grid StatusBarGrid => this.FindControl<Grid>("StatusBarGrid");
        public Button ZoomResetButton => this.FindControl<Button>("ZoomResetButton");
        public Label FileLengthKbLabel => this.FindControl<Label>("FileLengthKbLabel");
        public ContentControl ByteCountPanel => this.FindControl<ContentControl>("ByteCountPanel");
        public Label CountOfByteSumLabel => this.FindControl<Label>("CountOfByteSumLabel");
        public Label ReadOnlyLabel => this.FindControl<Label>("ReadOnlyLabel");
        public Label CountOfByteLabel => this.FindControl<Label>("CountOfByteLabel");

        public ScrollBar VerticalScrollBar => this.FindControl<ScrollBar>("VerticalScrollBar");
        public Grid MarkerGrid => this.FindControl<Grid>("MarkerGrid");
        public Rectangle BottomRectangle => this.FindControl<Rectangle>("BottomRectangle");
        public Rectangle TopRectangle => this.FindControl<Rectangle>("TopRectangle");

        public ProgressBar LongProgressProgressBar => this.FindControl<ProgressBar>("LongProgressProgressBar");
        public Border CancelLongProcessButton => this.FindControl<Border>("CancelLongProcessButton");
        public Button CancelLongProcessButtonInner => CancelLongProcessButton.FindLogicalDescendantOfType<Button>();
        public Label TblLabel => this.FindControl<Label>("TblLabel");
        ...
        {
            #region Changed
            AllowBuildinCtrlcProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowBuildinCTRLPropertyChanged(x, e));
            AllowBuildinCtrlvProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowBuildinCTRLPropertyChanged(x, e));
            AllowBuildinCtrlaProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowBuildinCTRLPropertyChanged(x, e));
            AllowBuildinCtrlzProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowBuildinCTRLPropertyChanged(x, e));
            AllowBuildinCtrlyProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowBuildinCTRLPropertyChanged(x, e));

            SelectionFirstColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            SelectionSecondColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            ByteModifiedColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            MouseOverColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            ByteDeletedColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            ByteAddedColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            HighLightColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));

            ForegroundProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            ForegroundSecondColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            ForegroundContrastProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));
            BarChartColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ColorPropertyChanged(x, e));

            ForegroundHighLightOffSetHeaderColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ForegroundOffSetHeaderColorPropertyChanged(x, e));
            ForegroundOffSetHeaderColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_ForegroundOffSetHeaderColorPropertyChanged(x, e));

            BackgroundProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_BackgroundColorPropertyChanged(x, e));
            FontFamilyProperty.Changed.AddClassHandler<HexEditor>((x, e) => FontFamily_Changed(x, e));
            LineHeightProperty.Changed.AddClassHandler<HexEditor>((x, e) => LineHeight_PropertyChanged(x, e));

            OffSetPanelVisualProperty.Changed.AddClassHandler<HexEditor>((x, e) => OffSetPanelVisual_PropertyChanged(x, e));
            OffSetPanelFixedWidthVisualProperty.Changed.AddClassHandler<HexEditor>((x, e) => OffSetPanelVisual_PropertyChanged(x, e));

            OffSetStringVisualProperty.Changed.AddClassHandler<HexEditor>((x, e) => DataVisualTypeProperty_PropertyChanged(x, e));
            OffSetDataStringStateProperty.Changed.AddClassHandler<HexEditor>((x, e) => DataStringVisualStateProperty_PropertyChanged(x, e));
            OffSetByteOrderProperty.Changed.AddClassHandler<HexEditor>((x, e) => DataByteOrderProperty_PropertyChanged(x, e));
            OffSetByteSizeProperty.Changed.AddClassHandler<HexEditor>((x, e) => DataByteSizeProperty_PropertyChanged(x, e));
            DataStringVisualProperty.Changed.AddClassHandler<HexEditor>((x, e) => DataStringVisualTypeProperty_PropertyChanged(x, e));
            TypeOfCharacterTableProperty.Changed.AddClassHandler<HexEditor>((x, e) => TypeOfCharacterTable_PropertyChanged(x, e));
            TblShowMteProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLShowMTE_PropetyChanged(x, e));

            TbldteColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLColor_Changed(x, e));
            TblmteColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLColor_Changed(x, e));
            TblEndBlockColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLColor_Changed(x, e));
            TblEndLineColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLColor_Changed(x, e));
            TblDefaultColorProperty.Changed.AddClassHandler<HexEditor>((x, e) => TBLColor_Changed(x, e));

            ReadOnlyModeProperty.Changed.AddClassHandler<HexEditor>((x, e) => ReadOnlyMode_PropertyChanged(x, e));
            SelectionStartProperty.Changed.AddClassHandler<HexEditor>((x, e) => SelectionStart_ChangedCallBack(x, e));
            SelectionStopProperty.Changed.AddClassHandler<HexEditor>((x, e) => SelectionStop_ChangedCallBack(x, e));
            IsHexDataVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsHexDataVisible_PropertyChanged(x, e));
            IsHeaderVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsHeaderVisible_PropertyChanged(x, e));
            IsStringDataVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsStringDataVisible_ValidateValue(x, e));
            IsBarChartPanelVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsBarChartPanelVisible_ValidateValue(x, e));
            IsStatusBarVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsStatusBarVisible_ValueChange(x, e));
            IsLineInfoVisibleProperty.Changed.AddClassHandler<HexEditor>((x, e) => IsLineInfoVisible_ValueChange(x, e));

            FileNameProperty.Changed.AddClassHandler<HexEditor>((x, e) => FileName_PropertyChanged(x, e));
            StreamProperty.Changed.AddClassHandler<HexEditor>((x, e) => Stream_PropertyChanged(x, e));

            BytePerLineProperty.Changed.AddClassHandler<HexEditor>((x, e) => BytePerLine_PropertyChanged(x, e));
            StringByteWidthProperty.Changed.AddClassHandler<HexEditor>((x, e) => StringByteWidth_PropertyChanged(x, e));
            AllowAutoHighLightSelectionByteProperty.Changed.AddClassHandler<HexEditor>((x, e) => AutoHighLiteSelectionByte_Changed(x, e));
            AutoHighLiteSelectionByteBrushProperty.Changed.AddClassHandler<HexEditor>((x, e) => AutoHighLiteSelectionByte_Changed(x, e));
            AllowByteCountProperty.Changed.AddClassHandler<HexEditor>((x, e) => AllowByteCount_PropertyChanged(x, e));
            ByteSpacerPositioningProperty.Changed.AddClassHandler<HexEditor>((x, e) => ByteSpacer_Changed(x, e));
            ByteSpacerWidthTicknessProperty.Changed.AddClassHandler<HexEditor>((x, e) => ByteSpacer_Changed(x, e));
            ByteGroupingProperty.Changed.AddClassHandler<HexEditor>((x, e) => ByteSpacer_Changed(x, e));
            ByteSpacerVisualStyleProperty.Changed.AddClassHandler<HexEditor>((x, e) => ByteSpacer_Changed(x, e));
            VisualCaretModeProperty.Changed.AddClassHandler<HexEditor>((x, e) => VisualCaretMode_Changed(x, e));
            ByteShiftLeftProperty.Changed.AddClassHandler<HexEditor>((x, e) => ByteShiftLeft_Changed(x, e));
            AllowVisualByteAdressProperty.Changed.AddClassHandler<HexEditor>((x, e) => AllowVisualByteAddress_Changed(x, e));
            VisualByteAdressLengthProperty.Changed.AddClassHandler<HexEditor>((x, e) => VisualByteAdressLength_Changed(x, e));
            VisualByteAdressStartProperty.Changed.AddClassHandler<HexEditor>((x, e) => VisualByteAdressStart_Changed(x, e));
            ZoomScaleProperty.Changed.AddClassHandler<HexEditor>((x, e) => ZoomScale_ChangedCallBack(x, e));
            AllowDeleteByteProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_DeletePropertyChanged(x, e));
            HideByteDeletedProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_DeletePropertyChanged(x, e));
            AllowAutoSelectSameByteAtDoubleClickProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_AllowAutoSelectSameByteAtDoubleClick(x, e));
            AllowCustomBackgroundBlockProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_CustomBackgroundBlockPropertyChanged(x, e));
            CanInsertEverywhereProperty.Changed.AddClassHandler<HexEditor>((x, e) => Control_CanInsertEverywhereChanged(x, e));
            #endregion Changed
        ...
        public HexEditor()
        {
            ...
            // Analogy to WPF Loaded event
            AttachedToVisualTree += Control_Loaded;
            AddHandler(KeyDownEvent, Control_KeyDown);
            AddHandler(PointerWheelChangedEvent, Control_MouseWheel);
            AddHandler<DragEventArgs>(DragDrop.DropEvent, Control_Drop);
            // TODO: check for memory leaks
            UndoCMenu.AddHandler(MenuItem.ClickEvent, UndoCMenu_Click);
            BookMarkCMenu.AddHandler(MenuItem.ClickEvent, BookMarkCMenu_Click);
            ClearBookMarkCMenu.AddHandler(MenuItem.ClickEvent, ClearBookMarkCMenu_Click);
            CopyHexaCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyAsciicMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyCcMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyCSharpCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyFSharpCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyJavaCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyVbNetCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyPascalCMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            CopyTblcMenu.AddHandler(MenuItem.ClickEvent, CopyToClipBoardCMenu_Click);
            PasteMenu.AddHandler(MenuItem.ClickEvent, PasteMenu_Click);
            FillByteCMenu.AddHandler(MenuItem.ClickEvent, FillByteCMenu_Click);
            ReplaceByteCMenu.AddHandler(MenuItem.ClickEvent, ReplaceByteCMenu_Click);
            DeleteCMenu.AddHandler(MenuItem.ClickEvent, DeleteCMenu_Click);
            FindAllCMenu.AddHandler(MenuItem.ClickEvent, FindAllCMenu_Click);
            SelectAllCMenu.AddHandler(MenuItem.ClickEvent, SelectAllCMenu_Click);

            // Analogy to WPF SizeChanged event
            BaseGrid.GetPropertyChangedObservable(Grid.BoundsProperty)
                .Subscribe(args => Grid_SizeChanged(BaseGrid, args as AvaloniaPropertyChangedEventArgs<Rect>));
            ZoomResetButton.AddHandler(Button.ClickEvent, ZoomResetButton_Click);
            VerticalScrollBar.GetPropertyChangedObservable(ScrollBar.ValueProperty)
                .Subscribe(args => VerticalScrollBar_ValueChanged(VerticalScrollBar, args as AvaloniaPropertyChangedEventArgs<double>));
            BottomRectangle.AddHandler(Rectangle.PointerPressedEvent, BottomRectangle_MouseDown);
            BottomRectangle.AddHandler(Rectangle.PointerEnterEvent, BottomRectangle_MouseEnter);
            BottomRectangle.AddHandler(Rectangle.PointerLeaveEvent, BottomRectangle_MouseLeave);
            TopRectangle.AddHandler(Rectangle.PointerPressedEvent, TopRectangle_MouseDown);
            TopRectangle.AddHandler(Rectangle.PointerEnterEvent, TopRectangle_MouseEnter);
            TopRectangle.AddHandler(Rectangle.PointerLeaveEvent, TopRectangle_MouseLeave);
            CancelLongProcessButtonInner.AddHandler(Button.ClickEvent, CancelLongProcessButton_Click);
        ...
        {
            get => GetValue(AllowBuildinCtrlcProperty);
            set => SetValue(AllowBuildinCtrlcProperty, value);
        }

        public static readonly StyledProperty<bool> AllowBuildinCtrlcProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowBuildinCtrlc), defaultValue: true);
        ...
        {
            get => GetValue(AllowBuildinCtrlvProperty);
            set => SetValue(AllowBuildinCtrlvProperty, value);
        }

        public static readonly StyledProperty<bool> AllowBuildinCtrlvProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowBuildinCtrlv), defaultValue: true);
        ...
        {
            get => GetValue(AllowBuildinCtrlaProperty);
            set => SetValue(AllowBuildinCtrlaProperty, value);
        }

        public static readonly StyledProperty<bool> AllowBuildinCtrlaProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowBuildinCtrla), defaultValue: true);
        ...
        {
            get => GetValue(AllowBuildinCtrlzProperty);
            set => SetValue(AllowBuildinCtrlzProperty, value);
        }

        public static readonly StyledProperty<bool> AllowBuildinCtrlzProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowBuildinCtrlz), defaultValue: true);
        ...
        {
            get => GetValue(AllowBuildinCtrlyProperty);
            set => SetValue(AllowBuildinCtrlyProperty, value);
        }

        public static readonly StyledProperty<bool> AllowBuildinCtrlyProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowBuildinCtrly), defaultValue: true);

        private static void Control_AllowBuildinCTRLPropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        public static readonly StyledProperty<IBrush> SelectionFirstColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(SelectionFirstColor), defaultValue: Brushes.CornflowerBlue);
        ...
        public static readonly StyledProperty<IBrush> SelectionSecondColorProperty =
           AvaloniaProperty.Register<HexEditor, IBrush>(nameof(SelectionSecondColor), defaultValue: Brushes.LightSteelBlue);
        ...
        public static readonly StyledProperty<IBrush> ByteModifiedColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ByteModifiedColor), defaultValue: Brushes.DarkGray);
        ...
        public static readonly StyledProperty<IBrush> MouseOverColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(MouseOverColor), defaultValue: Brushes.LightSkyBlue);
        ...
        public static readonly StyledProperty<IBrush> ByteDeletedColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ByteDeletedColor), defaultValue: Brushes.Red);
        ...
        public static readonly StyledProperty<IBrush> ByteAddedColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ByteAddedColor), defaultValue: Brushes.Transparent);
        ...
        public static readonly StyledProperty<IBrush> HighLightColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(HighLightColor), defaultValue: Brushes.Gold);
        ...
        public static readonly StyledProperty<IBrush> ForegroundHighLightOffSetHeaderColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ForegroundHighLightOffSetHeaderColor), defaultValue: Brushes.Black);
        ...
        public static readonly StyledProperty<IBrush> ForegroundOffSetHeaderColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ForegroundOffSetHeaderColor), defaultValue: Brushes.Gray);

        private static void Control_ForegroundOffSetHeaderColorPropertyChanged(IAvaloniaObject d,
        ...
        public new static readonly StyledProperty<IBrush> ForegroundProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(Foreground), defaultValue: Brushes.Black);
        ...
        public static readonly StyledProperty<IBrush> ForegroundSecondColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ForegroundSecondColor), defaultValue: Brushes.Blue);
        ...
        public static readonly StyledProperty<IBrush> ForegroundContrastProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(ForegroundContrast), defaultValue: Brushes.White);

        public new static readonly StyledProperty<IBrush> BackgroundProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(Background), defaultValue: Brushes.White);
        ...
        public static readonly StyledProperty<IBrush> BarChartColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(BarChartColor), defaultValue: Brushes.DarkGray);

        private static void Control_BackgroundColorPropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        private static void Control_ColorPropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public new static readonly StyledProperty<FontFamily> FontFamilyProperty =
            AvaloniaProperty.Register<HexEditor, FontFamily>(nameof(FontFamily), defaultValue: new FontFamily("Courier New"));

        private static void FontFamily_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<string> ApplicationNameProperty =
            AvaloniaProperty.Register<HexEditor, string>(nameof(ApplicationName), defaultValue: "Avalonia HexEditor");

        /// <summary>
        /// Length of file opened.
        /// </summary>
        public string FileLengthKbLabelText
        {
            get => (string)GetValue(FileLengthKbLabelTextProperty);
            set => SetValue(FileLengthKbLabelTextProperty, value);
        }

        public static readonly StyledProperty<string> FileLengthKbLabelTextProperty =
            AvaloniaProperty.Register<HexEditor, string>(nameof(FileLengthKbLabelText));
        ...
        public static readonly StyledProperty<double> LineHeightProperty =
            AvaloniaProperty.Register<HexEditor, double>(nameof(LineHeight), defaultValue: 18D);

        private static void LineHeight_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs _)
        {
        ...
        public static readonly StyledProperty<OffSetPanelType> OffSetPanelVisualProperty =
            AvaloniaProperty.Register<HexEditor, OffSetPanelType>(nameof(OffSetPanelVisual), defaultValue: OffSetPanelType.OffsetOnly);

        private static void OffSetPanelVisual_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.UpdateLinesInfo();
        }
        ...
        public static readonly StyledProperty<OffSetPanelFixedWidth> OffSetPanelFixedWidthVisualProperty =
            AvaloniaProperty.Register<HexEditor, OffSetPanelFixedWidth>(nameof(OffSetPanelFixedWidthVisual), defaultValue: OffSetPanelFixedWidth.Dynamic);
        ...
        public static readonly StyledProperty<bool> ShowByteToolTipProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(ShowByteToolTip), defaultValue: false);
        ...
        public static readonly StyledProperty<DataVisualType> OffSetStringVisualProperty =
            AvaloniaProperty.Register<HexEditor, DataVisualType>(nameof(OffSetStringVisual), defaultValue: DataVisualType.Hexadecimal);

        private static void DataVisualTypeProperty_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<DataVisualState> OffSetDataStringStateProperty =
           AvaloniaProperty.Register<HexEditor, DataVisualState>(nameof(DataStringState), defaultValue: DataVisualState.Default);

        private static void DataStringVisualStateProperty_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<ByteOrderType> OffSetByteOrderProperty =
           AvaloniaProperty.Register<HexEditor, ByteOrderType>(nameof(ByteOrder), defaultValue: ByteOrderType.LoHi);

        private static void DataByteOrderProperty_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<ByteSizeType> OffSetByteSizeProperty =
           AvaloniaProperty.Register<HexEditor, ByteSizeType>(nameof(ByteSize), defaultValue: ByteSizeType.Bit8);

        private static void DataByteSizeProperty_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<DataVisualType> DataStringVisualProperty =
            AvaloniaProperty.Register<HexEditor, DataVisualType>(nameof(DataStringVisual), defaultValue: DataVisualType.Hexadecimal);

        private static void DataStringVisualTypeProperty_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<CharacterTableType> TypeOfCharacterTableProperty =
            AvaloniaProperty.Register<HexEditor, CharacterTableType>(nameof(TypeOfCharacterTable), defaultValue: CharacterTableType.Ascii);

        private static void TypeOfCharacterTable_PropertyChanged(IAvaloniaObject d,
            AvaloniaPropertyChangedEventArgs e)
        {
        ...
        public static readonly StyledProperty<bool> TblShowMteProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(TblShowMte), defaultValue: true);

        private static void TBLShowMTE_PropetyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.RefreshView();
        }
        ...
        public void LoadTblFile(string fileName)
        {
            ...
            TblLabel.IsVisible = true;
            ToolTip.SetTip(TblLabel, $"TBL file : {fileName}");
        ...
        public void LoadDefaultTbl(DefaultCharacterTableType type = DefaultCharacterTableType.Ascii)
        {
            ...
            TblLabel.IsVisible = true;
            ToolTip.SetTip(TblLabel, $"{Localizer.Localizer.Instance["HexEditor/DefaultTBLString"]} : {type}");
        ...
        public static readonly StyledProperty<IBrush> TbldteColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(TbldteColor), defaultValue: Brushes.Red);

        private static void TBLColor_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.RefreshView();
        }
        ...
        public static readonly StyledProperty<IBrush> TblmteColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(TblmteColor), defaultValue: Brushes.DarkSlateGray);
        ...
        public static readonly StyledProperty<IBrush> TblEndBlockColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(TblEndBlockColor), defaultValue: Brushes.Blue);
        ...
        public static readonly StyledProperty<IBrush> TblEndLineColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(TblEndLineColor), defaultValue: Brushes.Blue);
        ...
        public static readonly StyledProperty<IBrush> TblDefaultColorProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(TblDefaultColor), defaultValue: Brushes.Black);
        ...
        public static readonly StyledProperty<bool> ReadOnlyModeProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(ReadOnlyMode), defaultValue: false);

        private static void ReadOnlyMode_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        private int MaxScreenVisibleLine
        {
            get
            {
                var actualheight = GetCurrentScreen().Bounds.Height;
        ...
        public static readonly StyledProperty<long> SelectionLineProperty =
            AvaloniaProperty.Register<HexEditor, long>(nameof(SelectionLine), defaultValue: 0L);

        private void LinesInfoLabel_MouseMove(object sender, PointerEventArgs e)
        {
            if (!(sender is FastTextLine line) || e.GetCurrentPoint(line).Properties.IsLeftButtonPressed != true) return;
        ...
        private void LinesInfoLabel_MouseDown(object sender, PointerPressedEventArgs e)
        {
        ...
        private void Control_MovePageUp(object sender, ByteEventArgs e)
        {
            ...
            if (GetProperties(sender, e).modifiers == KeyModifiers.Shift)
        ...
        public static readonly StyledProperty<long> SelectionStartProperty =
            AvaloniaProperty.Register<HexEditor, long>(nameof(SelectionStart), defaultValue: -1L, coerce: SelectionStart_CoerceValueCallBack);

        private static long SelectionStart_CoerceValueCallBack(IAvaloniaObject d, long baseValue)
        {
        ...
        private static void SelectionStart_ChangedCallBack(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
            if (e.NewValue == e.OldValue) return;
            if (!CheckIsOpen(ctrl._provider)) return;
        ...
        public static readonly StyledProperty<long> SelectionStopProperty =
            AvaloniaProperty.Register<HexEditor, long>(nameof(SelectionStop), defaultValue: -1L, coerce: SelectionStop_CoerceValueCallBack);

        private static long SelectionStop_CoerceValueCallBack(IAvaloniaObject d, long baseValue)
        {
        ...
        private static void SelectionStop_ChangedCallBack(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        private void Paste(bool expendIfneeded)
        {
            ...
            var clipBoardText = Application.Current.Clipboard.GetTextAsync().Result;
            ...
            if (expendIfneeded && AllowExtend && needToBeExtent)
                ...
                {
                    if (MessageBoxManager.GetMessageBoxStandardWindow(
                    new MessageBoxStandardParams
                    {
                        ButtonDefinitions = ButtonEnum.YesNo,
                        ContentMessage = Localizer.Localizer.Instance["HexEditor/PasteExtendByteConfirmationString"],
                        ContentTitle = ApplicationName,
                        Icon = Icon.Warning
                    }).ShowDialog(GetCurrentWindow()).Result == ButtonResult.Yes)
                        expend = true;
                }
                else
                    expend = true;
            ...
            SetScrollMarker(SelectionStart, ScrollMarker.ByteModified, Localizer.Localizer.Instance["HexEditor/PasteFromClipboardString"]);
            RefreshView();
        ...
        public void FillWithByte(long startPosition, long length, byte val)
        {
            ...
            SetScrollMarker(SelectionStart, ScrollMarker.ByteModified, Localizer.Localizer.Instance["HexEditor/FillSelectionAloneString"]);
            RefreshView();
        }
        ...
        /// </summary>
        public bool IsHexDataVisible
        {
            get => (bool)GetValue(IsHexDataVisibleProperty);
            set => SetValue(IsHexDataVisibleProperty, value);
        }

        public static readonly StyledProperty<bool> IsHexDataVisibleProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(IsHexDataVisible), defaultValue: true, coerce: Visibility_CoerceValue);

        private static bool Visibility_CoerceValue(IAvaloniaObject d, bool baseValue) =>
            baseValue;

        private static void IsHexDataVisible_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
            ...
            {
                case true:
                    ctrl.HexDataStackPanel.IsVisible = true;

                    if (ctrl.IsHeaderVisible == true)
                        ctrl.HexHeaderStackPanel.IsVisible = true;
                    break;

                case false:
                    ctrl.HexDataStackPanel.IsVisible = false;
                    ctrl.HexHeaderStackPanel.IsVisible = false;
                    break;
            }
        }
        ...
        public static readonly StyledProperty<bool> IsHeaderVisibleProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(IsHeaderVisible), defaultValue: true, coerce: Visibility_CoerceValue);

        private static void IsHeaderVisible_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
            ...
            {
                case true:
                    if (ctrl.IsHexDataVisible == true)
                    {
                        ctrl.HexHeaderStackPanel.IsVisible = true;
                        ctrl.TopRectangle.IsVisible = true;
                    }
                    break;

                case false:
                    ctrl.HexHeaderStackPanel.IsVisible = false;
                    ctrl.TopRectangle.IsVisible = false;
                    break;
            }
        }
        ...
        /// </summary>
        public bool IsStringDataVisible
        {
            get => (bool)GetValue(IsStringDataVisibleProperty);
            set => SetValue(IsStringDataVisibleProperty, value);
        }

        public static readonly StyledProperty<bool> IsStringDataVisibleProperty =
            AvaloniaProperty.Register<HexEditor, bool>(
                nameof(IsStringDataVisible),
                defaultValue: true,
                coerce: Visibility_CoerceValue
                );

        private static void IsStringDataVisible_ValidateValue(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;

            ctrl.StringDataStackPanel.IsVisible = (bool)e.NewValue;
            if ((bool)e.NewValue == true)
            {
                ctrl.IsBarChartPanelVisible = false;
            }
            ctrl.RefreshView(true);
        }
        ...
        /// </summary>
        public bool IsBarChartPanelVisible
        {
            get => (bool)GetValue(IsBarChartPanelVisibleProperty);
            set => SetValue(IsBarChartPanelVisibleProperty, value);
        }

        public static readonly StyledProperty<bool> IsBarChartPanelVisibleProperty =
            AvaloniaProperty.Register<HexEditor, bool>(
                nameof(IsBarChartPanelVisible),
                defaultValue: false,
                coerce: Visibility_CoerceValue
            );

        private static void IsBarChartPanelVisible_ValidateValue(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        private static void IsStatusBarVisible_ValueChange(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;

            ctrl.ReadOnlyLabel.IsVisible =
            ctrl.StatusBarGrid.IsVisible =
            ctrl.BottomRectangle.IsVisible =
                (bool)e.NewValue;
        ...
        /// </summary>
        public bool IsLineInfoVisible
        {
            get => (bool)GetValue(IsLineInfoVisibleProperty);
            set => SetValue(IsLineInfoVisibleProperty, value);
        }

        public static readonly StyledProperty<bool> IsLineInfoVisibleProperty =
            AvaloniaProperty.Register<HexEditor, bool>(
                nameof(IsLineInfoVisible),
                defaultValue: true,
                coerce: Visibility_CoerceValue);

        private static void IsLineInfoVisible_ValueChange(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;

            ctrl.LinesInfoStackPanel.IsVisible = (bool)e.NewValue;
        ...
        public static readonly StyledProperty<bool> IsFileOrStreamLoadedProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(IsFileOrStreamLoaded), defaultValue: false);
        ...
        public static readonly StyledProperty<string> FileNameProperty =
            AvaloniaProperty.Register<HexEditor, string>(nameof(FileName), defaultValue: string.Empty);

        private static void FileName_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        public static readonly StyledProperty<Stream> StreamProperty =
            AvaloniaProperty.Register<HexEditor, Stream>(nameof(Stream), defaultValue: null);

        private static void Stream_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        private void CheckProviderIsOnProgress()
        {
            ...
            {
                CancelLongProcessButton.IsVisible = true;
                LongProgressProgressBar.IsVisible = true;
                enableCtrl = false;
            }
            else
            {
                CancelLongProcessButton.IsVisible = false;
                LongProgressProgressBar.IsVisible = false;
                enableCtrl = true;
            }
        ...
        public static readonly StyledProperty<int> BytePerLineProperty =
            AvaloniaProperty.Register<HexEditor, int>(nameof(BytePerLine), defaultValue: 16, coerce: BytePerLine_CoerceValue);

        private static int BytePerLine_CoerceValue(IAvaloniaObject d, int baseValue) =>
            (int)baseValue < 1 ? 1 : ((int)baseValue > 64 ? 64 : baseValue);

        private static void BytePerLine_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<double> StringByteWidthProperty =
            AvaloniaProperty.Register<HexEditor, double>(nameof(StringByteWidth), defaultValue: 10d, coerce: StringByteWidth_CoerceValue);

        private static double StringByteWidth_CoerceValue(IAvaloniaObject d, double baseValue) =>
            (double)baseValue < 1 ? 1 : ((double)baseValue > 64 ? 64 : baseValue);

        private static void StringByteWidth_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        private void VerticalScrollBar_ValueChanged(object sender, AvaloniaPropertyChangedEventArgs<double> e)
        {
            RefreshView();
        ...
        private void Grid_SizeChanged(object sender, AvaloniaPropertyChangedEventArgs<Rect> e)
        {
            // Height did not change or don't refresh on resize.
            if ((e.NewValue.Value.Height == e.OldValue.Value.Height) || !IsAutoRefreshOnResize) return;
        ...
        private void BuildDataLines(int maxline, bool rebuild = false)
        {
            ...
            for (var lineIndex = StringDataStackPanel.Children.Count; lineIndex < maxline; lineIndex++)
            {
                ...
                for (var i = 0; i < BytePerLine * ByteSizeRatio; i++)
                {
                    ...
                    new StringByte(this, IsBarChartPanelVisible == true, StringByteWidth).With(c =>
                    {
                        c.Clear();
                    ...
                    if (index < readSize && _priLevel == curLevel)
                    {
                        switch (ByteSize)
                        {
                            case ByteSizeType.Bit8:
                                ...
                                break;
                            case ByteSizeType.Bit16:
                                ctrl.Byte = new Byte_16bit(new byte[] { _viewBuffer[index], _viewBuffer[index + 1] });
                                break;
                            case ByteSizeType.Bit32:
                                ctrl.Byte = new Byte_32bit(new byte[] { _viewBuffer[index], _viewBuffer[index + 1], _viewBuffer[index + 2], _viewBuffer[index + 3] });
                                break;
                            default:
                                throw new NotImplementedException();
                        }
...
&& ctrl.Action != ByteAction.Deleted;
        ...
        private void UpdateHeader(bool clear = false)
        {
            ...
            for (var i = HexHeaderStackPanel.Children.Count; i < BytePerLine; i++)
            {
                ...
                var headerLabel = new FastTextLine(this)
                {
                    Height = LineHeight,
                    AutoWidth = false,
                    FontWeight = hlHeader ? FontWeight.Bold : FontWeight.Normal,
            ...
            if (linesCount < maxVisibleLine)
                for (var i = 0; i < maxVisibleLine - linesCount; i++)
                    new FastTextLine(this).With(l =>
                    {
                        ...
                        //Events
                        l.PointerPressed += LinesInfoLabel_MouseDown;
                        l.PointerMoved += LinesInfoLabel_MouseMove;
            ...
            for (var i = 0; i < maxVisibleLine; i++)
            {
                ...
                lineOffsetLabel.With(l =>
                {
                        ...
                        SelectionStart <= endLine)
                    {
                        ...
                        ToolTip.SetTip(l, $"{Localizer.Localizer.Instance["HexEditor/FirstByteString"]} : {SelectionStart}");
                    ...
                    else
                    {
                        ...
                        l.Foreground = ForegroundOffSetHeaderColor;
                        ToolTip.SetTip(l, $"{Localizer.Localizer.Instance["HexEditor/FirstByteString"]} : {firstByteInLine}");
                    ...
                    switch (OffSetStringVisual)
                    {
                        case DataVisualType.Hexadecimal:
                            switch (OffSetPanelVisual)
                            {
                                case OffSetPanelType.OffsetOnly:
                                    l.Text = $"0x{LongToHex(actualPosition, OffSetPanelFixedWidthVisual).ToUpperInvariant()}";
                                    break;
                                case OffSetPanelType.LineOnly:
                                    l.Text = $"ln {LongToHex(GetLineNumber(actualPosition), OffSetPanelFixedWidthVisual).ToUpperInvariant()}";
                                    break;
                                case OffSetPanelType.Both:
                                    l.Text = $"ln {LongToHex(GetLineNumber(actualPosition), OffSetPanelFixedWidthVisual)} 0x{LongToHex(actualPosition, OffSetPanelFixedWidthVisual).ToUpperInvariant()}";
                                    break;
                                default:
                                    throw new NotImplementedException();
                            }
                        ...
                        case DataVisualType.Decimal:
                            ...
                            {
                                case OffSetPanelType.OffsetOnly:
                                    l.Text = $"d{actualPosition.ToString(format)}";
                                    break;
                                case OffSetPanelType.LineOnly:
                                    l.Text = $"ln {GetLineNumber(actualPosition).ToString(format)}";
                                    break;
                                case OffSetPanelType.Both:
                                    l.Text = $"ln {GetLineNumber(actualPosition).ToString(format)} d{actualPosition.ToString(format)}";
                                    break;
                                default:
                                    throw new NotImplementedException();
                            }
        ...
        public void ReplaceByte(long startPosition, long length, byte original, byte replace)
        {
            ...
            SetScrollMarker(SelectionStart, ScrollMarker.ByteModified, Localizer.Localizer.Instance["HexEditor/ReplaceWithByteString"]);
            RefreshView();
        }
        ...
        {
            if (IsStatusBarVisible != true) return;
            ...
            if (updateFileLenght)
            {
                ...
                FileLengthKbLabel.Content = Math.Round(length, 2) +
                                            (isMegabByte
                                                ? $" {Localizer.Localizer.Instance["HexEditor/MBTagString"]}"
                                                : $" {Localizer.Localizer.Instance["HexEditor/KBTagString"]}");
            }
            #endregion
            ...
            if (AllowByteCount && _bytecount != null && SelectionStart > -1)
            {
                ...
                ByteCountPanel.IsVisible = false;
        ...
        private void SetScrollMarker(long position, ScrollMarker marker, string description = "")
        {
            ...
            var track = FindTrack(VerticalScrollBar);
            var topPosition = (track == null) ? double.NaN :
                (GetLineNumber(bookMark.BytePositionInStream) * track.TickHeight(MaxLine) - 1).Round(1);
            ...
            new Rectangle().With(r =>
            {
                ...
                switch (marker)
                {
                    ...
                    case ScrollMarker.Bookmark:
                        ToolTip.SetTip(r, TryFindResource("ScrollMarkerSearchToolTip"));
                    ...
                    case ScrollMarker.SelectionStart:
                        ...
                        r.Width = VerticalScrollBar.Bounds.Width;
                        r.Height = 3;
                        break;
                ...
                r.PointerPressed += Rect_MouseDown;
        ...
        private void Rect_MouseDown(object sender, PointerPressedEventArgs e)
        {
        ...
        private void UpdateScrollMarkerPosition() =>
            TraverseScrollMarker(ctrl =>
            {
                ...
                try
                {
                    ...
                    (
                        0,
                        GetLineNumber(bm.BytePositionInStream) * track.TickHeight(MaxLine) - ctrl.Bounds.Height,
                        0,
                        0
                    );
                }
        ...
        private void FillByteCMenu_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (window.ShowDialog<bool>(GetCurrentWindow()).Result == true && window.HexTextBox.LongValue <= 255)
        ...
        private void BottomRectangle_MouseEnter(object sender, PointerEventArgs e)
        {
            _mouseOnBottom = true;
        ...
        private void TopRectangle_MouseEnter(object sender, PointerEventArgs e)
        {
        ...
        private void BottomRectangle_MouseLeave(object sender, PointerEventArgs e) => _mouseOnBottom = false;

        private void TopRectangle_MouseLeave(object sender, PointerEventArgs e) => _mouseOnTop = false;

        private void BottomRectangle_MouseDown(object sender, PointerPressedEventArgs e) => _mouseOnBottom = false;

        private void TopRectangle_MouseDown(object sender, PointerPressedEventArgs e) => _mouseOnTop = false;
        ...
        private void Control_MouseWheel(object sender, PointerWheelEventArgs e)
        {
            #region Mousewheel Zoom support
            if (_scaler == null) InitialiseZoom();

            if (e.KeyModifiers == KeyModifiers.Control && AllowZoom)
            {
                if (e.Delta.Y > 0) //Zoom
                    ZoomScale += 0.1;

                if (e.Delta.Y < 0) //UnZoom
                    ZoomScale -= 0.1;
            ...
            {
                if (e.Delta.Y > 0) //UP
                    VerticalScrollBar.Value -= e.Delta.Y / 120 *
                        (MouseWheelSpeed == MouseWheelSpeed.System
                            ? GlobalParameters.Instance.WheelScrollLines
                            : (int)MouseWheelSpeed);
        ...
        public static readonly StyledProperty<bool> AllowAutoHighLightSelectionByteProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowAutoHighLightSelectionByte), defaultValue: true);

        /// <summary>
        /// Brush used to color the selectionbyte
        /// </summary>
        public IBrush AutoHighLiteSelectionByteBrush
        {
            get => (IBrush)GetValue(AutoHighLiteSelectionByteBrushProperty);
            set => SetValue(AutoHighLiteSelectionByteBrushProperty, value);
        }

        public static readonly StyledProperty<IBrush> AutoHighLiteSelectionByteBrushProperty =
            AvaloniaProperty.Register<HexEditor, IBrush>(nameof(AutoHighLiteSelectionByteBrush), defaultValue: Brushes.LightBlue);

        private static void AutoHighLiteSelectionByte_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.UpdateVisual();
        }
        ...
        public static readonly StyledProperty<bool> AllowByteCountProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowByteCount), defaultValue: false);

        private static void AllowByteCount_PropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        public static readonly StyledProperty<ByteSpacerPosition> ByteSpacerPositioningProperty =
            AvaloniaProperty.Register<HexEditor, ByteSpacerPosition>(nameof(ByteSpacerPositioning), defaultValue: ByteSpacerPosition.Both);
        ...
        public static readonly StyledProperty<ByteSpacerWidth> ByteSpacerWidthTicknessProperty =
            AvaloniaProperty.Register<HexEditor, ByteSpacerWidth>(nameof(ByteSpacerWidthTickness), defaultValue: ByteSpacerWidth.Normal);

        private static void ByteSpacer_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.RefreshView(true);
        }
        ...
        public static readonly StyledProperty<ByteSpacerGroup> ByteGroupingProperty =
            AvaloniaProperty.Register<HexEditor, ByteSpacerGroup>(nameof(ByteGrouping), defaultValue: ByteSpacerGroup.EightByte);
        ...
        public static readonly StyledProperty<ByteSpacerVisual> ByteSpacerVisualStyleProperty =
            AvaloniaProperty.Register<HexEditor, ByteSpacerVisual>(nameof(ByteSpacerVisualStyle), defaultValue: ByteSpacerVisual.Empty);
            ...
            if (!forceEmpty)
                switch (ByteSpacerVisualStyle)
                {
                    ...
                    case ByteSpacerVisual.Line:
                        ...
                        {
                            StartPoint = new Point((int)ByteSpacerWidthTickness / 2D, 0d),
                            EndPoint = new Point((int)ByteSpacerWidthTickness / 2D, LineHeight),
                            Stroke = BorderBrush,
                            StrokeThickness = 1,
                    ...
                    case ByteSpacerVisual.Dash:
                        ...
                        {
                            StartPoint = new Point((int)ByteSpacerWidthTickness / 2D, 0d),
                            EndPoint = new Point((int)ByteSpacerWidthTickness / 2D, LineHeight - 1),
                            Stroke = BorderBrush,
                            StrokeDashArray = new AvaloniaList<double>(new double[] { 2 }),
                            StrokeThickness = 1,
                            Width = (int)ByteSpacerWidthTickness
                        });
        ...
        public static readonly StyledProperty<CaretMode> VisualCaretModeProperty =
            AvaloniaProperty.Register<HexEditor, CaretMode>(nameof(VisualCaretMode), defaultValue: CaretMode.Insert);

        private static void VisualCaretMode_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
        ...
        internal void AppendByte(byte[] bytesToAppend)
        {
            ...
            if (AppendNeedConfirmation)
                if (MessageBoxManager.GetMessageBoxStandardWindow(
                    ...
                    {
                        ButtonDefinitions = ButtonEnum.YesNo,
                        ContentMessage = Localizer.Localizer.Instance["HexEditor/AppendByteConfirmationString"],
                        ContentTitle = ApplicationName,
                        Icon = Icon.Warning,
                    }).ShowDialog(GetCurrentWindow()).Result == ButtonResult.Yes)
                    return;
        ...
        private void Control_Drop(object sender, DragEventArgs e)
        {
            ...
            var textDrop = e.Data.Get(DataFormats.Text);
            ...
            var fileDrop = e.Data.Get(DataFormats.FileNames);
                ...
                else
                {
                    if (FileDroppingConfirmation)
                    {
                        if (MessageBoxManager.GetMessageBoxStandardWindow(
                            ...
                            {
                                ButtonDefinitions = ButtonEnum.YesNo,
                                ContentMessage = $"{Localizer.Localizer.Instance["HexEditor/FileDroppingConfirmationString"]} {Path.GetFileName(filename[0])} ?",
                                ContentTitle = ApplicationName,
                                Icon = Icon.Warning
                            }).ShowDialog(GetCurrentWindow()).Result == ButtonResult.Yes)
                            FileName = filename[0];
...
&& readOnlyMode;
        ...
        public static readonly StyledProperty<int> ByteShiftLeftProperty =
            AvaloniaProperty.Register<HexEditor, int>(nameof(ByteShiftLeft), defaultValue: 0, coerce: ByteShiftLeft_CoerceValue);

        private static void ByteShiftLeft_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (d is HexEditor ctrl)
                ctrl.RefreshView(true);
        }

        private static int ByteShiftLeft_CoerceValue(IAvaloniaObject d, int basevalue) =>
            (int)basevalue < 0
                ? 0
                : basevalue;
        ...
        public static readonly StyledProperty<bool> AllowVisualByteAdressProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowVisualByteAddress), defaultValue: false);

        private static void AllowVisualByteAddress_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<long> VisualByteAdressLengthProperty =
            AvaloniaProperty.Register<HexEditor, long>(nameof(VisualByteAdressLength), defaultValue: 1L, coerce: VisualByteAdressLength_CoerceValue);

        private static long VisualByteAdressLength_CoerceValue(IAvaloniaObject d, long baseValue)
        {
            if (!(d is HexEditor ctrl)) return baseValue;
        ...
        private static void VisualByteAdressLength_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<long> VisualByteAdressStartProperty =
            AvaloniaProperty.Register<HexEditor, long>(nameof(VisualByteAdressStart), defaultValue: 0L, coerce: VisualByteAdressStart_CoerceValue);

        private static long VisualByteAdressStart_CoerceValue(IAvaloniaObject d, long baseValue)
        {
            if (!(d is HexEditor ctrl)) return baseValue;
        ...
        private static void VisualByteAdressStart_Changed(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<PreloadByteInEditor> PreloadByteInEditorModeProperty =
            AvaloniaProperty.Register<HexEditor, PreloadByteInEditor>(nameof(PreloadByteInEditorMode), defaultValue: PreloadByteInEditor.None);

        // Changed RoutedEventArgs to VisualTreeAttachmentEventArgs.
        private void Control_Loaded(object sender, VisualTreeAttachmentEventArgs e) =>
        ...
        public void ForcePreloadByteInEditor(PreloadByteInEditor preloadByte, bool refreshView = true)
        {
            ...
            switch (preloadByte)
            {
                case PreloadByteInEditor.None:
                    nbLine = 0; // Not preload byte
                    break;
                case PreloadByteInEditor.MaxVisibleLine:
                    nbLine = MaxVisibleLine;
                    break;
                case PreloadByteInEditor.MaxVisibleLineExtended:
                    nbLine = MaxVisibleLine + 10;
                    break;
                case PreloadByteInEditor.MaxScreenVisibleLine:
                    nbLine = MaxScreenVisibleLine;
                    break;
                case PreloadByteInEditor.MaxScreenVisibleLineAtDataLoad:
                    nbLine = MaxVisibleLine; // Other line loaded at first file/stream loaded
                    break;
                default:
                    throw new NotImplementedException();
            }
        ...
        public static readonly StyledProperty<double> ZoomScaleProperty =
            AvaloniaProperty.Register<HexEditor, double>(nameof(ZoomScale), defaultValue: 1D, coerce: ZoomScale_CoerceValueCallBack);

        private static double ZoomScale_CoerceValueCallBack(IAvaloniaObject d, double baseValue) =>
            (double)baseValue >= 0.5 && (double)baseValue <= 2.0001
                ? (double)baseValue
                : d.GetValue(ZoomScaleProperty);

        private static void ZoomScale_ChangedCallBack(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl)) return;
            if (e.NewValue == e.OldValue) return;
        ...
        private void InitialiseZoom()
        {
            ...
            HexHeaderStackPanelLayout.LayoutTransform = _scaler;
            HexDataStackPanelLayout.LayoutTransform = _scaler;
            StringDataStackPanelLayout.LayoutTransform = _scaler;
            LinesInfoStackPanelLayout.LayoutTransform = _scaler;
        ...
        public static readonly StyledProperty<bool> AllowDeleteByteProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowDeleteByte), defaultValue: true);
        ...
        public static readonly StyledProperty<bool> HideByteDeletedProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(HideByteDeleted), defaultValue: true);

        private static void Control_DeletePropertyChanged(IAvaloniaObject d,
            AvaloniaPropertyChangedEventArgs e)
        {
        ...
        public static readonly StyledProperty<bool> AllowAutoSelectSameByteAtDoubleClickProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowAutoSelectSameByteAtDoubleClick), defaultValue: true);

        private static void Control_AllowAutoSelectSameByteAtDoubleClick(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static readonly StyledProperty<bool> AllowCustomBackgroundBlockProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(AllowCustomBackgroundBlock), defaultValue: false);

        private static void Control_CustomBackgroundBlockPropertyChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        public static StyledProperty<ICommand> RefreshViewCommandProperty =
            AvaloniaProperty.Register<HexEditor, ICommand>(
                nameof(RefreshViewCommand)
            );

        public static StyledProperty<ICommand> SubmitChangesCommandProperty
            = AvaloniaProperty.Register<HexEditor, ICommand>(
        ...
        public static readonly StyledProperty<bool> CanInsertEverywhereProperty =
            AvaloniaProperty.Register<HexEditor, bool>(nameof(CanInsertEverywhere), defaultValue: false);

        private static void Control_CanInsertEverywhereChanged(IAvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
            if (!(d is HexEditor ctrl) || e.NewValue == e.OldValue) return;
        ...
        {
            return this.GetSelfAndLogicalAncestors().OfType<Window>().First();
        }

        private Screen GetCurrentScreen()
        {
            var window = GetCurrentWindow();
            return window.Screens.ScreenFromPoint(window.Position);
        }

        private object TryFindResource(object key)
        {
            if (this.TryFindResource(key, out object value))
                return value;
            return null;
        }

        private (Key key, KeyModifiers modifiers) GetProperties(object sender, ByteEventArgs e)
        {
            if (e.Inner is KeyEventArgs key)
            {
                return (key.Key, key.KeyModifiers);
            }
            return (Key.None, KeyModifiers.None);
        }

        private Track FindTrack(ScrollBar scrollBar)
        {
            return scrollBar.GetVisualDescendants().OfType<Track>().FirstOrDefault();
        }
    }
}
