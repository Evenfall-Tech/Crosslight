...
namespace Crosslight.Transformer.Viewer.Views.Utils
{
    public class NodeTypeToIconConverter : IBindingTypeConverter
    {
        ...
        public bool TryConvert(object from, Type toType, object conversionHint, out object result)
        {
            do
            {
                ...
                result = new Bitmap(Assets.Open(new Uri($"avares://Crosslight.Transformer.Viewer/Assets/Icons/{drawingName}")));
                return true;
