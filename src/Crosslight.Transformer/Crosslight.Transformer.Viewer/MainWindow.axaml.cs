...
using Crosslight.Transformer.CIL.Transformers;
...
using Crosslight.Transformer.Viewer.Views.Viewports;
using ReactiveUI;
...
namespace Crosslight.Transformer.Viewer
{
    public class MainWindow : ReactiveWindow<MainWindowViewModel>
    {
        ...
        private async void OnButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                InputTransformer = new CILInputTransformer(),
                OutputTransformer = null,
            };

            Node ast = GetNodeFromFSItem(context.InputTransformer.Translate(source));
            if (ast == null)
            {
                return;
            }
