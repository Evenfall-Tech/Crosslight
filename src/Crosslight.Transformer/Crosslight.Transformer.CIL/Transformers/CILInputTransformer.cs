...
using Crosslight.Transformer.CIL.Nodes;
using Crosslight.Transformer.CIL.Nodes.Visitors;
...
namespace Crosslight.Transformer.CIL.Transformers
{
    public class CILInputTransformer : ITransformer
    {
