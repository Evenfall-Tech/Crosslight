...
using Crosslight.Transformer.CIL.Util.ILSpy;
...
namespace Crosslight.Transformer.CIL.Nodes.Visitors.Syntax
{
    public class SyntaxTreeVisitor : AbstractVisitor<SyntaxTree>
    {
        ...
        public override Node Visit(SyntaxTree node)
        {
            try
            {
                ...
                List<NamespaceDeclarationNode> resultingNamespaceNodes = new List<NamespaceDeclarationNode>();
                foreach (var ns in namespaces)
                {
                    ...
                    if (!(nsNode is NamespaceDeclarationNode namespaceNode))
                    {
        ...
        private List<NamespaceDeclarationNode> SplitAll(IEnumerable<NamespaceDeclarationNode> original)
        {
        ...
        {
            public NamespaceDeclarationNode Node { get; }
