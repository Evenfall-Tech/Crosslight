...
public:
     ...
     */
    [[nodiscard]] const struct cl_resource_types* cl_resource_types_input() const;

    /**
     * @brief Get the C representation of output resource types.
     */
    [[nodiscard]] const struct cl_resource_types* cl_resource_types_output() const;

    /**
     * @brief Terminate the C representation of resource types.
     */
    static std::size_t cl_resource_types_term(const struct cl_resource_types* types);
